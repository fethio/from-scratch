...
(custom-set-variables
 ...
 '(package-selected-packages
   '(htmlize ox-reveal imaxima magit flycheck-clang-analyzer flycheck company-shell company-jedi company-irony company-c-headers elpy expand-region popup-kill-ring linum-relative mark-multiple avy swiper ivy company dashboard sudo-edit hungry-delete switch-window smex ido-vertical-mode yasnippet beacon spacemacs-theme which-key)))
(custom-set-faces
